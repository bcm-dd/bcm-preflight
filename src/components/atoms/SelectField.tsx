import { SelectField as SelectFieldType } from '@payloadcms/plugin-form-builder/dist/types'
...
function SelectField(field: SelectFieldProps): ReactElement {
	const { name, label, width, options, control, required, errors, watch } =
		field
	...
	return (
		<Field blockType="select" width={width ?? 100}>
			<Controller
				control={control}
				rules={{ required }}
				name={name}
